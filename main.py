...
try:
    while midgard.is_active():
        ...
        top_frames = np.hstack((orig_frame, flow_diff_vis, flow_uv_warped_vis, flow_diff_vis // 2 + flow_uv_warped_vis // 2))
        bottom_frames = np.hstack((midgard.flow_vis, blocks_vis, flow_uv_warped_mag_vis, blocks_vis // 2 + flow_uv_warped_mag_vis // 2))
